  ...
  return (
    ...
    <div className="flex flex-wrap mt-20">
      {products.data?.map((product) => (
        <div key={product.id} className="w-full max-w-xs bg-color-secondary border border-color-secondary rounded-lg shadow-md flex flex-col justify-between mx-3 my-2">
