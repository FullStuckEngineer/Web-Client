  ...
  return (
    <>
      <div className="w-full flex flex-row my-20 gap-4">
        <div className="w-full flex flex-row  h-auto mb-4 p-10 rounded-lg shadow-lg bg-gradient-to-br from-color-emerald-300 to-color-secondary">
          <form
            onSubmit={handleSubmit}
            className="w-full flex flex-row border h-auto mb-4 p-10 rounded-lg shadow-lg bg-gradient-to-br from-color-emerald-300 to-color-secondary"
          >
          ...
          <div className="w-full flex flex-col border h-auto mb-4 p-10 rounded-lg shadow-lg bg-gradient-to-br from-color-emerald-300 to-color-secondary">
            ...
            {imageUploaded ? (
              ...
              <button
                className="w-1/3 p-2font-bold rounded-lg h-10 bg-color-emerald-100 hover:transition-all text-white my-2 shadow-sm hover:bg-color-green"
                onClick={() => document.getElementById("upload-input").click()}
              >
                Upload Picture
              </button>
