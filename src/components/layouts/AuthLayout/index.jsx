...
const AuthLayout = (props) => {
  ...
  return (
    <header className="flex flex-wrap w-full md:py-28 py-40 md:px-10 px-5">
      ...
      <div className="flex flex-col items-center justify-center md:w-1/2 w-full h-max">
        ...
        <div className="w-full md:w-2/3 px-10 py-14 shadow-xl rounded-lg">
          ...
          <p className="text-color-dark text-sm text-center mt-4">
            {linkText}
            <Link href={link} className="text-color-green font-bold">
              {linkName}
            </Link>
          </p>
        </div>
